...
title: \ c4s4 /
permalink: /
subtitle: <a href='#'>Tu eres incondicionalmente amado y apoyado.</a>
...
profile:
  ...
  content: about_me.md
  more_info: >
    Lo único que descubres en lo desconocido es más de ti mismo.
...
# :black_small_square::black_medium_small_square::black_medium_square::black_large_square: Bienvenido a mi ricón!! :black_large_square::black_medium_square::black_medium_small_square::black_small_square:

---

---

##### ¡Hola!!:wave::v::sparkling_heart:<br>

Este es mi avatar, **atziluth**. Sé que está escrito un poco críptico… Me gusta el estilo hacker de renombrar cosas… jejeje :sweat_smile:
...
- [Repositorios](repos) Repositorios de mi GitHub, donde subo proyectos y experimentos.

- [Contenido Interesante](news): Publicaré cosas que me gustan, incluyendo material inspirador, noticias curiosas y muchas más cosas. :wink:<br>
  - _Recursos que me ayuden a darme a conocer y encontrar una **empresa de ciberseguridad** para completar mis prácticas y lanzar mi carrera._ :smile:<br><br>
...
> `Este es un espacio para explorar, aprender y conectar. Creo en cuestionar lo establecido y buscar verdades más profundas, y espero que aquí encuentres algo valioso también.` :wink: <br>
> {:center}
...
{:center: style="text-align: center"}
_¡Gracias por pasarte por aquí! Espero que encuentres algo que despierte tu curiosidad!!_
{:center}
